#define NGX_CONFIGURE " --with-http_ssl_module --with-pcre --with-pcre-jit --with-debug --prefix=/home/nginx-install --with-cc-opt='-g -gdwarf-4 -O0'"
...
#ifndef NGX_COMPILER
#define NGX_COMPILER  "gcc 11.5.0 20240719 (Red Hat 11.5.0-5) (GCC) "
#endif
...
#ifndef NGX_PREFIX
#define NGX_PREFIX  "/home/nginx-install/"
#endif
